...
public class EmailUtil {
    ...
    public void sendSetpasswordEmail(String email) throws MessagingException {
        ...
        String linkHtml = String.format(
                "<div>\n" +
                        "  <a href=\"http://localhost:9090/User/set-password?email=%s\" target=\"_blank\">click link to set password</a>\n" +
                        "</div>",
                email
        );
        mimeMessageHelper.setText(linkHtml, true);
    ...
    public static String htmlMailExemple(){
        return "<html xmlns:v=\"urn:schemas-microsoft-com:vml\"><head>\n" +
                ...
                "                                            <a href=\"http://localhost:9090/Reclamation\"  style=\"color: #ffffff; text-decoration: none;\">Read More</a>\n" +
                "                                        </div>\n" +
                "                                    </td>\n" +
                "                                </tr>\n" +
                "\n" +
                ...
                "\n" +
                "                                            Email us: <br> <a href=\"mailto:\" style=\"color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;\">contact@ourstartup.com</a>\n" +
                "\n" +
                "                                        </div>\n" +
                "                                    </td>\n" +
                "                                </tr>\n" +
